...
public class Login_form extends JFrame {
    ...
    private void initComponent(){
        ...
        facebook_icon.setIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/fb.png"))));
        facebook_icon.setBounds(320,470,40,40);

        gmail_icon.setIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/gmail.png"))));
        gmail_icon.setBounds(380,470,45,40);

        twitter_icon.setIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/twiter.png"))));
